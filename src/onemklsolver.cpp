...
namespace H4I::MKLShim
{
  ...
  int64_t Sgebrd_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::gebrd_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
  ...
  int64_t Dgebrd_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::gebrd_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
  ...
  int64_t Cgebrd_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::gebrd_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Cgebrd_scratchpad")
  }
  int64_t Zgebrd_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::gebrd_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
  ...
  void Sgebrd(Context* ctxt, int64_t m, int64_t n, float* a, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::gebrd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, a, lda, d, e, tauq, taup,
  ...
  void Cgebrd(Context* ctxt, int64_t m, int64_t n, float _Complex* a, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::gebrd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, reinterpret_cast<std::complex<float>*>(a), lda,
  ...
  void Zgebrd(Context* ctxt, int64_t m, int64_t n, double _Complex* a, int64_t lda,
                    ...
                    int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::gebrd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, reinterpret_cast<std::complex<double>*>(a), lda,
  ...
  int64_t Sorgbr_ScPadSz(Context* ctxt,onemklGen gen, int64_t m, int64_t n, int64_t k,
                              int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::orgbr_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(gen), m, n, k, lda);
    return size;
  ...
  int64_t Dorgbr_ScPadSz(Context* ctxt,onemklGen gen, int64_t m, int64_t n, int64_t k,
                              int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::orgbr_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(gen), m, n, k, lda);
    return size;
  ...
  void Sorgbr(Context* ctxt, onemklGen gen, int64_t m, int64_t n, int64_t k, float* A, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::orgbr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(gen), m, n, k, A, lda, tua, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sorgbr")
  }
  ...
  int64_t Cungbr_ScPadSz(Context* ctxt,onemklGen gen, int64_t m, int64_t n, int64_t k,
                              int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ungbr_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(gen), m, n, k, lda);
    return size;
  ...
  int64_t Zungbr_ScPadSz(Context* ctxt,onemklGen gen, int64_t m, int64_t n, int64_t k,
                              int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ungbr_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(gen), m, n, k, lda);
    return size;
  ...
  void Cungbr(Context* ctxt, onemklGen gen, int64_t m, int64_t n, int64_t k, float _Complex* A, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::ungbr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(gen), m, n, k, reinterpret_cast<std::complex<float>*>(A), lda,
  ...
  void Zungbr(Context* ctxt, onemklGen gen, int64_t m, int64_t n, int64_t k, double _Complex* A, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::ungbr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(gen), m, n, k, reinterpret_cast<std::complex<double>*>(A), lda,
  ...
  int64_t Sorgqr_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t k, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::orgqr_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, k, lda);
    return size;
  ...
  int64_t Dorgqr_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t k, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::orgqr_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, k, lda);
    return size;
  ...
  void Sorgqr(Context* ctxt, int64_t m, int64_t n, int64_t k, float* A, int64_t lda,
                    float* tua, float* scratchpad, int64_t scratchpad_size) {
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::orgqr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, k, A, lda, tua, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sorgqr")
  }
  ...
  int64_t Cungqr_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t k, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ungqr_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, k, lda);
    return size;
  ...
  int64_t Zungqr_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t k, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ungqr_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, k, lda);
    return size;
  ...
  void Cungqr(Context* ctxt, int64_t m, int64_t n, int64_t k, float _Complex* A, int64_t lda,
                    float _Complex* tua, float _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::ungqr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, k, reinterpret_cast<std::complex<float>*>(A), lda,
                                          reinterpret_cast<std::complex<float>*>(tua), reinterpret_cast<std::complex<float>*>(scratchpad),
                                          scratchpad_size);
    ONEMKL_CATCH("Cungqr")
  }
  void Zungqr(Context* ctxt, int64_t m, int64_t n, int64_t k, double _Complex* A, int64_t lda,
                    double _Complex* tua, double _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::ungqr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, k, reinterpret_cast<std::complex<double>*>(A), lda,
                                          reinterpret_cast<std::complex<double>*>(tua), reinterpret_cast<std::complex<double>*>(scratchpad),
                                          scratchpad_size);
    ONEMKL_CATCH("Zungqr")
  }
  ...
  int64_t Sorgtr_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::orgtr_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
  ...
  int64_t Dorgtr_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::orgtr_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
  ...
  void Sorgtr(Context* ctxt, onemklUplo uplo, int64_t n, float* A, int64_t lda,
                    float* tua, float* scratchpad, int64_t scratchpad_size) {
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::orgtr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, A, lda, tua, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sorgtr")
  }
  ...
  int64_t Cungtr_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ungtr_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
  ...
  int64_t Zungtr_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ungtr_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
  ...
  void Cungtr(Context* ctxt, onemklUplo uplo, int64_t n, float _Complex* A, int64_t lda,
                    float _Complex* tua, float _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::ungtr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<float>*>(A), lda,
                                          reinterpret_cast<std::complex<float>*>(tua), reinterpret_cast<std::complex<float>*>(scratchpad),
                                          scratchpad_size);
    ONEMKL_CATCH("Cungtr")
  }
  void Zungtr(Context* ctxt, onemklUplo uplo, int64_t n, double _Complex* A, int64_t lda,
                    double _Complex* tua, double _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::ungtr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<double>*>(A), lda,
                                          reinterpret_cast<std::complex<double>*>(tua), reinterpret_cast<std::complex<double>*>(scratchpad),
                                          scratchpad_size);
    ONEMKL_CATCH("Zungtr")
  }
  ...
  int64_t Sormqr_ScPadSz(Context* ctxt, onemklSideMode side, onemklTranspose trans, int64_t m, int64_t n, int64_t k,
    ...
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ormqr_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(trans), m, n, k, lda, ldc);
    return size;
  ...
  int64_t Dormqr_ScPadSz(Context* ctxt, onemklSideMode side, onemklTranspose trans, int64_t m, int64_t n, int64_t k,
                    int64_t lda, int64_t ldc) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ormqr_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(trans), m, n, k, lda, ldc);
    return size;
  ...
  int64_t Cunmqr_ScPadSz(Context* ctxt, onemklSideMode side, onemklTranspose trans, int64_t m, int64_t n, int64_t k,
                    int64_t lda, int64_t ldc) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::unmqr_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(trans), m, n, k, lda, ldc);
    return size;
  ...
  int64_t Zunmqr_ScPadSz(Context* ctxt, onemklSideMode side, onemklTranspose trans, int64_t m, int64_t n, int64_t k,
                    int64_t lda, int64_t ldc) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::unmqr_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(trans), m, n, k, lda, ldc);
    return size;
  ...
  void Sormqr(Context* ctxt, onemklSideMode side, onemklTranspose trans, int64_t m, int64_t n, int64_t k,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::ormqr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(trans), m, n, k, A, lda, tua, C, ldc, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sormqr")
  }
  ...
  void Cunmqr(Context* ctxt, onemklSideMode side, onemklTranspose trans, int64_t m, int64_t n, int64_t k,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::unmqr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(trans), m, n, k,
  ...
  int64_t Sormtr_ScPadSz(Context* ctxt, onemklSideMode side, onemklUplo uplo, onemklTranspose trans, int64_t m, int64_t n,
                    int64_t lda, int64_t ldc) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ormtr_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(uplo), convert(trans), m, n, lda, ldc);
    return size;
  ...
  int64_t Dormtr_ScPadSz(Context* ctxt, onemklSideMode side, onemklUplo uplo, onemklTranspose trans, int64_t m, int64_t n,
                    int64_t lda, int64_t ldc) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::ormtr_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(uplo), convert(trans), m, n, lda, ldc);
    return size;
  ...
  void Sormtr(Context* ctxt, onemklSideMode side, onemklUplo uplo, onemklTranspose trans, int64_t m, int64_t n, float* A, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::ormtr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(uplo), convert(trans), m, n, A, lda, tua, C, ldc,
                                             scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sormtr")
  }
  ...
  int64_t Cunmtr_ScPadSz(Context* ctxt, onemklSideMode side, onemklUplo uplo, onemklTranspose trans, int64_t m, int64_t n,
                    int64_t lda, int64_t ldc) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::unmtr_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(uplo), convert(trans), m, n, lda, ldc);
    return size;
  ...
  int64_t Zunmtr_ScPadSz(Context* ctxt, onemklSideMode side, onemklUplo uplo, onemklTranspose trans, int64_t m, int64_t n,
                    int64_t lda, int64_t ldc) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::unmtr_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(uplo), convert(trans), m, n, lda, ldc);
    return size;
  ...
  void Cunmtr(Context* ctxt, onemklSideMode side, onemklUplo uplo, onemklTranspose trans, int64_t m, int64_t n, float _Complex* A, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::unmtr(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(side), convert(uplo), convert(trans), m, n,
                                            reinterpret_cast<std::complex<float>*>(A), lda, reinterpret_cast<std::complex<float>*>(tua),
                                            reinterpret_cast<std::complex<float>*>(C), ldc, reinterpret_cast<std::complex<float>*>(scratchpad),
                                            scratchpad_size);
    ONEMKL_CATCH("Cunmtr")
  ...
  int64_t Sgeqrf_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::geqrf_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Sgeqrf_scratchpad")
  }
  int64_t Dgeqrf_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::geqrf_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Dgeqrf_scratchpad")
  }
  int64_t Cgeqrf_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::geqrf_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Cgeqrf_scratchpad")
  }
  int64_t Zgeqrf_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::geqrf_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
  ...
  void Sgeqrf(Context* ctxt, int64_t m, int64_t n, float* A, int64_t lda, float* tua, float* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::geqrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, A, lda, tua, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sgeqrf")
  }
  ...
  void Cgeqrf(Context* ctxt, int64_t m, int64_t n, float _Complex* A, int64_t lda, float _Complex* tua, float _Complex* scratchpad,
             int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::geqrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, reinterpret_cast<std::complex<float>*>(A), lda,
  ...
  void Zgeqrf(Context* ctxt, int64_t m, int64_t n, double _Complex* A, int64_t lda, double _Complex* tua, double _Complex* scratchpad,
             int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::geqrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, reinterpret_cast<std::complex<double>*>(A), lda,
  ...
  int64_t Sgetrf_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::getrf_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Sgetrf_scratchpad")
  }
  int64_t Dgetrf_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::getrf_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Dgetrf_scratchpad")
  }
  int64_t Cgetrf_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::getrf_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Cgetrf_scratchpad")
  }
  int64_t Zgetrf_ScPadSz(Context* ctxt, int64_t m, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::getrf_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, lda);
    return size;
  ...
  void Sgetrf(Context* ctxt, int64_t m, int64_t n, float* A, int64_t lda, int64_t *ipiv, float* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::getrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, A, lda, ipiv, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sgetrf")
  }
  ...
  void Cgetrf(Context* ctxt, int64_t m, int64_t n, float _Complex* A, int64_t lda, int64_t *ipiv, float _Complex* scratchpad,
             int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::getrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, reinterpret_cast<std::complex<float>*>(A), lda, ipiv,
                                             reinterpret_cast<std::complex<float>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Cgetrf")
  }
  void Zgetrf(Context* ctxt, int64_t m, int64_t n, double _Complex* A, int64_t lda, int64_t *ipiv, double _Complex* scratchpad,
             int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::getrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, m, n, reinterpret_cast<std::complex<double>*>(A), lda, ipiv,
                                             reinterpret_cast<std::complex<double>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Zgetrf")
  }
  ...
  int64_t Sgetrs_ScPadSz(Context* ctxt, onemklTranspose trans, int64_t n, int64_t nrhs, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::getrs_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(trans), n, nrhs, lda, ldb);
    return size;
  ...
  int64_t Dgetrs_ScPadSz(Context* ctxt, onemklTranspose trans, int64_t n, int64_t nrhs, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::getrs_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(trans), n, nrhs, lda, ldb);
    return size;
  ...
  int64_t Cgetrs_ScPadSz(Context* ctxt, onemklTranspose trans, int64_t n, int64_t nrhs, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::getrs_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(trans), n, nrhs, lda, ldb);
    return size;
  ...
  int64_t Zgetrs_ScPadSz(Context* ctxt, onemklTranspose trans, int64_t n, int64_t nrhs, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::getrs_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(trans), n, nrhs, lda, ldb);
    return size;
  ...
  void Sgetrs(Context* ctxt, onemklTranspose trans, int64_t n, int64_t nrhs, float* A, int64_t lda, std::int64_t *ipiv,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::getrs(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(trans), n, nrhs, A, lda, ipiv, B, ldb, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sgetrs")
  }
  ...
  void Cgetrs(Context* ctxt, onemklTranspose trans, int64_t n, int64_t nrhs, float _Complex* A, int64_t lda, std::int64_t *ipiv,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::getrs(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(trans), n, nrhs, reinterpret_cast<std::complex<float>*>(A), lda, ipiv,
  ...
  void Zgetrs(Context* ctxt, onemklTranspose trans, int64_t n, int64_t nrhs, double _Complex* A, int64_t lda, std::int64_t *ipiv,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::getrs(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(trans), n, nrhs, reinterpret_cast<std::complex<double>*>(A), lda, ipiv,
...
//potrf
  int64_t Spotrf_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potrf_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Spotrf_ScPadSz")
  }
  int64_t Dpotrf_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potrf_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Dpotrf_ScPadSz")
  }
  int64_t Cpotrf_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potrf_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Cpotrf_ScPadSz")
  }
  int64_t Zpotrf_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potrf_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
  ...
  void Spotrf(Context* ctxt, onemklUplo uplo, int64_t n, float* A, int64_t lda, float* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, A, lda, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Spotrf")
  }
  ...
  void Cpotrf(Context* ctxt, onemklUplo uplo, int64_t n, float _Complex* A, int64_t lda, float _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<float>*>(A), lda,
                                             reinterpret_cast<std::complex<float>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Cpotrf")
  }
  void Zpotrf(Context* ctxt, onemklUplo uplo, int64_t n, double _Complex* A, int64_t lda, double _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<double>*>(A), lda,
                                             reinterpret_cast<std::complex<double>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Zpotrf")
  }
...
//potrf
  int64_t Spotri_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potri_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Spotri_ScPadSz")
  }
  int64_t Dpotri_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potri_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Dpotri_ScPadSz")
  }
  int64_t Cpotri_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potri_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Cpotri_ScPadSz")
  }
  int64_t Zpotri_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potri_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
  ...
  void Spotri(Context* ctxt, onemklUplo uplo, int64_t n, float* A, int64_t lda, float* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potri(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, A, lda, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Spotri")
  }
  ...
  void Cpotri(Context* ctxt, onemklUplo uplo, int64_t n, float _Complex* A, int64_t lda, float _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potri(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<float>*>(A), lda,
                                             reinterpret_cast<std::complex<float>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Cpotri")
  }
  void Zpotri(Context* ctxt, onemklUplo uplo, int64_t n, double _Complex* A, int64_t lda, double _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potri(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<double>*>(A), lda,
                                             reinterpret_cast<std::complex<double>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Zpotri")
  }
  ...
  int64_t Spotrs_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t nrhs, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potrs_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, nrhs, lda, ldb);
    return size;
  ...
  int64_t Dpotrs_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t nrhs, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potrs_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, nrhs, lda, ldb);
    return size;
  ...
  int64_t Cpotrs_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t nrhs, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potrs_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, nrhs, lda, ldb);
    return size;
  ...
  int64_t Zpotrs_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t nrhs, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::potrs_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, nrhs, lda, ldb);
    return size;
  ...
  void Spotrs(Context* ctxt, onemklUplo uplo, int64_t n, int64_t nrhs, float* A, int64_t lda,
              float* B, int64_t ldb, float* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potrs(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, nrhs, A, lda, B, ldb, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Spotrs")
  }
  ...
  void Cpotrs(Context* ctxt, onemklUplo uplo, int64_t n, int64_t nrhs, float _Complex* A, int64_t lda,
              float _Complex* B, int64_t ldb, float _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potrs(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, nrhs, reinterpret_cast<std::complex<float>*>(A), lda,
                  reinterpret_cast<std::complex<float>*>(B), ldb, reinterpret_cast<std::complex<float>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Cpotrs")
  }
  void Zpotrs(Context* ctxt, onemklUplo uplo, int64_t n, int64_t nrhs, double _Complex* A, int64_t lda,
              double _Complex* B, int64_t ldb, double _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::potrs(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, nrhs, reinterpret_cast<std::complex<double>*>(A), lda,
                  reinterpret_cast<std::complex<double>*>(B), ldb, reinterpret_cast<std::complex<double>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Zpotrs")
  }
  ...
  int64_t Sgesvd_ScPadSz(Context* ctxt, signed char jobu, signed char jobvt, int64_t m, int64_t n,
    ...
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::gesvd_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(jobu), convert(jobvt), m, n, lda, ldu, ldvt);
    return size;
  ...
  int64_t Dgesvd_ScPadSz(Context* ctxt, signed char jobu, signed char jobvt, int64_t m, int64_t n,
                              int64_t lda, int64_t ldu, int64_t ldvt){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::gesvd_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(jobu), convert(jobvt), m, n, lda, ldu, ldvt);
    return size;
  ...
  int64_t Cgesvd_ScPadSz(Context* ctxt, signed char jobu, signed char jobvt, int64_t m, int64_t n,
                              int64_t lda, int64_t ldu, int64_t ldvt){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::gesvd_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(jobu), convert(jobvt), m, n, lda, ldu, ldvt);
    return size;
  ...
  int64_t Zgesvd_ScPadSz(Context* ctxt, signed char jobu, signed char jobvt, int64_t m, int64_t n,
                              int64_t lda, int64_t ldu, int64_t ldvt){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::gesvd_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(jobu), convert(jobvt), m, n, lda, ldu, ldvt);
    return size;
  ...
  void Sgesvd(Context* ctxt, signed char jobu, signed char jobvt, int64_t m, int64_t n, float* A, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::gesvd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(jobu), convert(jobvt), m, n, A, lda, S, U, ldu, V, ldv, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Sgesvd")
  }
  ...
  void Cgesvd(Context* ctxt, signed char jobu, signed char jobvt, int64_t m, int64_t n, float _Complex* A, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::gesvd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(jobu), convert(jobvt), m, n, reinterpret_cast<std::complex<float>*>(A), lda,
  ...
  void Zgesvd(Context* ctxt, signed char jobu, signed char jobvt, int64_t m, int64_t n, double _Complex* A, int64_t lda,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::gesvd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(jobu), convert(jobvt), m, n, reinterpret_cast<std::complex<double>*>(A), lda,
  ...
  int64_t Ssyevd_ScPadSz(Context* ctxt, onemklJob job, onemklUplo uplo, int64_t n, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::syevd_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(job), convert(uplo), n, lda);
    return size;
  ...
  int64_t Dsyevd_ScPadSz(Context* ctxt, onemklJob job, onemklUplo uplo, int64_t n, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::syevd_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(job), convert(uplo), n, lda);
    return size;
  ...
  void Ssyevd(Context* ctxt, onemklJob job, onemklUplo uplo, int64_t n, float* A, int64_t lda, float* w,
    ...
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::syevd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(job), convert(uplo), n, A, lda, w, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Ssyevd")
  }
  ...
  int64_t Cheevd_ScPadSz(Context* ctxt, onemklJob job, onemklUplo uplo, int64_t n, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::heevd_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(job), convert(uplo), n, lda);
    return size;
  ...
  int64_t Zheevd_ScPadSz(Context* ctxt, onemklJob job, onemklUplo uplo, int64_t n, int64_t lda) {
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::heevd_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(job), convert(uplo), n, lda);
    return size;
  ...
  void Cheevd(Context* ctxt, onemklJob job, onemklUplo uplo, int64_t n, float _Complex* A, int64_t lda, float* w,
                    float _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::heevd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(job), convert(uplo), n,
  ...
  int64_t Ssytrf_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::sytrf_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Ssytrf_ScPadSz")
  }
  int64_t Dsytrf_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::sytrf_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Dsytrf_ScPadSz")
  }
  int64_t Csytrf_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::sytrf_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Csytrf_ScPadSz")
  }
  int64_t Zsytrf_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::sytrf_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
  ...
  void Ssytrf(Context* ctxt, onemklUplo uplo, int64_t n, float* A, int64_t lda, int64_t* ipiv, float* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::sytrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, A, lda, ipiv, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Ssytrf")
  }
  ...
  void Csytrf(Context* ctxt, onemklUplo uplo, int64_t n, float _Complex* A, int64_t lda, int64_t* ipiv, float _Complex* scratchpad,
             int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::sytrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<float>*>(A), lda, ipiv,
                                            reinterpret_cast<std::complex<float>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Csytrf")
  }
  void Zsytrf(Context* ctxt, onemklUplo uplo, int64_t n, double _Complex* A, int64_t lda, int64_t* ipiv, double _Complex* scratchpad,
             int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::sytrf(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<double>*>(A), lda, ipiv,
                                            reinterpret_cast<std::complex<double>*>(scratchpad), scratchpad_size);
    ONEMKL_CATCH("Zsytrf")
  }
  ...
  int64_t Ssytrd_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::sytrd_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Ssytrd_ScPadSz")
  }
  int64_t Dsytrd_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::sytrd_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Dsytrd_ScPadSz")
  }
  int64_t Chetrd_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::hetrd_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
    ONEMKL_CATCH_NO_FLUSH("Chetrd_ScPadSz")
  }
  int64_t Zhetrd_ScPadSz(Context* ctxt, onemklUplo uplo, int64_t n, int64_t lda){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::hetrd_scratchpad_size<std::complex<double>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, lda);
    return size;
  ...
  void Ssytrd(Context* ctxt, onemklUplo uplo, int64_t n, float* A, int64_t lda, float* d, float* e, float* tau,
             float* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::sytrd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, A, lda, d, e, tau, scratchpad, scratchpad_size);
    ONEMKL_CATCH("Ssytrf")
  }
  ...
  void Chetrd(Context* ctxt, onemklUplo uplo, int64_t n, float _Complex* A, int64_t lda, float* d, float* e, float _Complex* tau,
             float _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::hetrd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<float>*>(A), lda, d, e,
  ...
  void Zhetrd(Context* ctxt, onemklUplo uplo, int64_t n, double _Complex* A, int64_t lda, double* d, double* e, double _Complex* tau,
             double _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::hetrd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, convert(uplo), n, reinterpret_cast<std::complex<double>*>(A), lda, d, e,
  ...
  int64_t Ssygvd_ScPadSz(Context* ctxt, int64_t itype, onemklJob job, onemklUplo uplo, int64_t n, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::sygvd_scratchpad_size<float>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, itype, convert(job), convert(uplo), n, lda, ldb);
  ...
  int64_t Dsygvd_ScPadSz(Context* ctxt, int64_t itype, onemklJob job, onemklUplo uplo, int64_t n, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::sygvd_scratchpad_size<double>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, itype, convert(job), convert(uplo), n, lda, ldb);
  ...
  int64_t Chegvd_ScPadSz(Context* ctxt, int64_t itype, onemklJob job, onemklUplo uplo, int64_t n, int64_t lda, int64_t ldb){
    ONEMKL_TRY_WITH_RET
    auto size = oneapi::mkl::lapack::hegvd_scratchpad_size<std::complex<float>>(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, itype, convert(job), convert(uplo), n, lda, ldb);
  ...
  void Ssygvd(Context* ctxt, int64_t itype, onemklJob job, onemklUplo uplo, int64_t n, float* A, int64_t lda, float* B, int64_t ldb, float* W,
              float* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::sygvd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, itype, convert(job), convert(uplo), n, A, lda, B, ldb, W,
                                            scratchpad, scratchpad_size);
    ONEMKL_CATCH("Ssygvd")
  }
  ...
  void Chegvd(Context* ctxt, int64_t itype, onemklJob job, onemklUplo uplo, int64_t n, float _Complex* A, int64_t lda, float _Complex* B, int64_t ldb, float* W,
              float _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::hegvd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, itype, convert(job), convert(uplo), n, reinterpret_cast<std::complex<float>*>(A), lda,
  ...
  void Zhegvd(Context* ctxt, int64_t itype, onemklJob job, onemklUplo uplo, int64_t n, double _Complex* A, int64_t lda, double _Complex* B, int64_t ldb, double* W,
              double _Complex* scratchpad, int64_t scratchpad_size){
    ONEMKL_TRY
    auto status = oneapi::mkl::lapack::hegvd(reinterpret_cast<ContextImpl*>(ctxt)->bedata->queue, itype, convert(job), convert(uplo), n, reinterpret_cast<std::complex<double>*>(A), lda,
